    ...
    <nav className="sticky top-0 z-50 border-b border-slate-200/80 bg-white/90 shadow-sm backdrop-blur-xl">
      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="relative">
            ...
            {/* Glow */}
            <span className="absolute inset-0 rounded-xl bg-cyan-400/20 blur-md transition duration-300 group-hover:bg-cyan-400/30" />
          ...
          {navLinks.map((link) => {
            ...
            return (
              <NavLink
                ...
                className={({ isActive }) =>
                  `group relative flex items-center gap-1.5 rounded-xl px-3 py-2 text-sm font-semibold transition-all duration-200 lg:px-3.5 ${
                    isActive
                  ...
                  <>
                    <Icon
                      ...
                      className={`transition-transform duration-200 ${
                        isActive
                          ? "text-cyan-600"
                          : "text-slate-400 group-hover:scale-110 group-hover:text-cyan-500"
                      }`}
                    />
                    ...
                    {/* Active indicator */}
                    {isActive && (
                      <span className="absolute -bottom-[1px] left-1/2 h-0.5 w-5 -translate-x-1/2 rounded-full bg-cyan-500" />
                    )}
                  </>
                )}
              </NavLink>
        ...
        <div className="hidden items-center gap-2 md:flex">
          ...
          <Link
            to="/profile"
            className="group flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm font-semibold text-slate-600 shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:border-cyan-200 hover:bg-cyan-50 hover:text-cyan-700 hover:shadow-md lg:px-3.5"
          >
            <User
              size={16}
          ...
          <button
            ...
            className="group flex items-center gap-2 rounded-xl bg-slate-900 px-3 py-2 text-sm font-semibold text-white shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:bg-red-500 hover:shadow-lg hover:shadow-red-500/20 lg:px-3.5"
          >
            <LogOut
              size={16}
      ...
      {isOpen && (
        <div className="border-t border-slate-200/80 bg-white px-4 pb-6 pt-4 shadow-xl md:hidden">
          ...
          {/* Mobile Brand Card */}
          <div className="mb-4 overflow-hidden rounded-2xl border border-cyan-100 bg-gradient-to-r from-cyan-50 via-blue-50 to-indigo-50 p-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="rounded-full bg-white px-2.5 py-1 text-[9px] font-bold uppercase tracking-wider text-cyan-600 shadow-sm">
                Member
              </div>
            </div>
          </div>
          ...
          >
            ...
            <ChevronRight
              size={16}
              className="ml-auto text-slate-300 transition group-hover:text-cyan-500"
            />
          </Link>
